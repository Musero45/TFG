% test of function getEndurance4givenVH_AllM
...
tic
  EM1 = getEndurance4givenVHM1(r4fRigidHe,V,H,atm,vWT,FC4,options);
toc

tic
  EM2 = getEndurance4givenVHM2(r4fRigidHe,V,H,atm,vWT,FC4,options);
toc

figure (1)

plot(V*3.6,EM1/3600,'ko-');
hold on
plot(V*3.6,EM2/3600,'ro-');
