function options = setHeroesRigidOptions2223
...
options.armonicInflowModel  = @none; % @none | @Coleman | @Drees | @Payne | @White | @Pitt | @Howlett
options.mrForces            = @completeF; % @completeF | @thrustF
options.trForces            = @completeF; % @completeF | @thrustF
options.mrMoments           = @aerodynamicM; % @elasticM | @aerodynamicM
