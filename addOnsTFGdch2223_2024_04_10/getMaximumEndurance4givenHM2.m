function [Emax,VC,ConFWvec] = getMaximumEndurance4givenHM2(r4fRigidHe,H,atm,vWT,FC4,options)
% [Emax,VC,ConFWvec] = getMaximumEndurance4givenHM2(r4fRigidHe,H,atm,vWT,FC4,options)
...
%
% The function uses getEndurance4givenVHM2 to calculate the range

negRfun = @(V)(-getEndurance4givenVHM2(r4fRigidHe,V,H,atm,vWT,FC4,options));
