function missionOut = getSegmentTaxi(he,atm,missIn,pos,varargin)
% getSegmentTaxi solves the mission taxi segment with given flight time and
% velocity.
%
...
% Additional Segment calculations
 ...
 missIn.mSeg{pos}.Z(2) = missIn.mSeg{pos}.Z(1);
   missIn.mSeg{pos}.DR = missIn.mSeg{pos}.V(1)*missIn.mSeg{pos}.DT;
