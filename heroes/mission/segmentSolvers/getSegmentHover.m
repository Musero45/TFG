function missionOut = getSegmentHover(he,atm,missIn,pos,varargin)
% getSegmentHover solves hover mission segment with given flight time.
%
% missionOut is a structure with the following fields:
%
%   class: 'missionSegment'
%      id: 'Hover'
%  solver: @MYgetSegmentHover
