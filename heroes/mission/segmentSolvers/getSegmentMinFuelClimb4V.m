function missionOut = getSegmentMinFuelClimb4V(he,atm,missIn,pos,varargin)
% getSegmentMinFuelClimb4V solves a mission climb segment with given 
% altitude increment, DH, flight velocity, V, and the minimum 
% fuel consumption. 
...
%      id: 'Climb'
%  solver: @MygetSegmentMinFuelClimb4V
...
%   
 ...
 ops       = optimset('Algorithm','active-set');
...
Vv                    = fmincon(myfun,Vv0,[],[],[],[],[],[],mycon,ops);
fc.Vv                 = Vv;
fc.Vh                 = sqrt(fc.V^2 - Vv^2);
