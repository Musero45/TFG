function missionOut = getSegmentCruiseTime(he,atm,missIn,pos,varargin)
% getSegmentCruiseRange solves the mission cruise segment with given
% flight time and flight velocity.
%
% missionOut is a structure with the following fields:
%
%   class: 'missionSegment'
%      id: 'CruiseTime'
%  solver: @MYgetSegmentCruiseTime
...
% Calculating the fuel mass consumption 
       ...
       missIn.mSeg{pos}.DR = missIn.mSeg{pos}.DT*V;
