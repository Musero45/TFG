function missionOut = getSegmentBestCruiseTime(he,atm,missIn,pos,varargin)
% getSegmentBestCruiseTime solves the mission cruise segment with given
% flight time and minimum fuel consumption. 
% The level cruise is calculated for maximum endurance velocity, VC, 
...
%      id: 'BestCruiseTime'
%  solver: @MYgetSegmentBestCruiseTime
