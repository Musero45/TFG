function missionOut = getSegmentDescent(he,atm,missIn,pos,varargin)
% getSegmentDescend solves the mission descend segment with given altiude
% increment, flight velocity and descent angle.   
%
% missionOut is a structure with the following fields:
%
%   class: 'missionSegment'
%      id: 'Descent'
%  solver: @MYgetSegmentDescend
...
% Getting segment flight condition
 ...
 fc = getFlightCondition(he,...
            ...
            'gammaT',missIn.mSeg{pos}.gammaT(1),...
