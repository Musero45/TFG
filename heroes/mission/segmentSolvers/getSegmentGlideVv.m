function missionOut = getSegmentGlideVv(he,atm,missIn,pos,varargin)
% getSegmentGlideVv solves the mission glide segment with given altitude
% increment and flight vertical velocity.
%   
% missionOut is a structure with the following fields:
%
%   class: 'missionSegment'
%      id: 'Glide'
%  solver: @MYgetSegmentGlideVv
...
fC = getFlightCondition(he,'Vv',missIn.mSeg{pos}.VV(1),...
...
[gammaT,Pdummy] = gammaTgivenPower(he,fC,atm,'constrainedEnginePower',...
                                     'flightCondition');
                                 
 fC.gammaT = gammaT;
 fC.V      = fC.Vv/sin(fC.gammaT);
 fC.Vh     = fC.V * cos(gammaT);
 P         = fC.P;
