function missionOut = getSegmentClimb(he,atm,missIn,pos,varargin)
% getSegmentClimb solves a mission climb segment with given altitude 
% increment, flight velocity and climb angle.
% 
% missionOut is a structure with the following fields:
%
%   class: 'missionSegment'
%      id: 'Climb'
%  solver: @MYgetSegmentClimb
