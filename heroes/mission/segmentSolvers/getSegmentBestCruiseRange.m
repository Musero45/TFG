function missionOut = getSegmentBestCruiseRange(he,atm,missIn,pos,varargin)
% getSegmentBestCruiseRange solves a mission cruise segment with given 
% range increment and minimum fuel consumption. 
% The level cruise is calculated for maximum range velocity, VB, 
% corresponding to the GW at the begining of the segment.
%
% missionOut is a structure with the following fields:
%
%   class: 'missionSegment'
%      id: 'BestCruiseRange'
%  solver: @MYgetSegmentBestCruiseRange
...
% Calculating the fuel mass consumption 
 ...
 missIn.mSeg{pos}.V(1) = VB;
 missIn.mSeg{pos}.V(2) = VB;
missIn.mSeg{pos}.VV(1) = 0;
missIn.mSeg{pos}.VV(2) = 0;
missIn.mSeg{pos}.VH(1) = VB;
missIn.mSeg{pos}.VH(2) = VB;
