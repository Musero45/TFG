function missionOut = getSegmentMinFuelClimb4Vh(he,atm,missIn,pos,varargin)
% getSegmentMinFuelClimb4V solves a mission climb segment with given 
% altitude increment, DH, flight horizontal velocity, V, and the minimum 
% fuel consumption. 
% The climb is calculated for the mission is calculated for vertical velocity
% minimizes segment energy, corresponding to the GW at the begining of the 
% segment.
% missionOut is a structure with the following fields:
%
%   class: 'missionSegment'
%      id: 'Climb'
%  solver: @MygetSegmentMinFuelClimb4Vh
