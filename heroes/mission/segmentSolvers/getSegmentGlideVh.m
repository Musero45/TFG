function missionOut = getSegmentGlideVh(he,atm,missIn,pos,varargin)
% getSegmentGlideVh solves the mission glide segment with given altiude 
% increment and flight horizontal velocity.
%
% missionOut is a structure with the following fields:
%
%   class: 'missionSegment'
%      id: 'Glide'
%  solver: @MYgetSegmentGlideVh
...
[Vv,gammaT]    = vV4vHpower(he,fC,atm,'constrainedEnginePower',...
                            'flightCondition');

fC.Vv     = Vv;
fC.gammaT = gammaT;
fC.V      = sqrt(fC.Vv^2 + fC.Vh^2);
P         = fC.P;
