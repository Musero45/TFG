function missionOut = getSegmentMinFuelClimb4VB(he,atm,missIn,pos,varargin)
% getSegmentMinFuelClimb4VB solves a mission climb segment with given 
...
%      id: 'Climb'
%  solver: @getSegmentMinFuelClimb4VB
...
[VB,PB] = vMaxRange(he,fc,atm,options);           
