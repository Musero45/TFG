function ClimbPlan = MinFuelClimb4VhSegmentBuilder(pos,DH,VH,DPL,Omega)
% MinFuelClimb4VhSegmentBuilder builds the mission segment corresponding
% to a climb for given altitude, DH, flight horizontal velocity, VH, and 
...
%        id: 'Climb'
%    solver: @getSegmentMinFuelClimb4Vh
%       pos: [1x1 double]
%         V: [1x2 double]
%    gammaT: [1x2 double]
%        VH: [1x2 double]
