function ClimbPlan = ClimbSegmentBuilder(pos,DH,V,gammaT,DPL,Omega)
% ClimbSegmentBuilder builds the mission segment corresponding to a climb 
% for given altitude increment, DH, flight velocity, V, and climb 
% angle, gammaT.  
%
...
% gammaT [1x1 double] is the climb angle [rad]
