function GlidePlan = GlideGammaTSegmentBuilder(pos,DH,gammaT,DPL,Omega)
% GlideGammaTSegmentBuilder builds the mission segment corresponding
% to a glide descent for given altiude increment, DH, and descent angle, 
% gammaT.
% 
