function GlidePlan = GlideMinVSegmentBuilder(pos,DH,DPL,Omega)
% GlideMinVSegmentBuilder builds the mission segment corresponding
% to a glide descent for given altitude increment, DH and minimum flight 
% velocity.
%
