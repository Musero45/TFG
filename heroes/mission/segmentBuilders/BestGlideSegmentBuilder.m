function GlidePlan = BestGlideSegmentBuilder(pos,DH,DPL,Omega)
% BestGlideSegmentBuilder builds the mission segment corresponding to a
% glide descent for given altitude increment, DH, and the minimum fuel
% consumption.
%
