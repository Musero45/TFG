function ClimbPlan = BestClimbSegmentBuilder(pos,DH,DPL,Omega)
% BestClimbSegmentBuilder builds the mission segment corresponding to a 
% climb for a given altitude increment, DH, and the minimum fuel consumption.
%
