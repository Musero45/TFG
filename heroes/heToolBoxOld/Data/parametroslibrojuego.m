...
%DATOS DEL ROTOR PRINCIPAL
    ...
    e_rp = 0.035*R_rp;     %Excentricidad de la pala
    k_beta = 48149*17;
    Mp = 130;
    xGB = 3.2;
...
%DATOS DE LOS ESTABILIZADORES
    ...
    AirfoilEH = @NACA0012dat;
        ...
        SDerecho = Sestabhorizontal*(4/4);       %Porcentaje de la total
    ...
    AirfoilEV = @NACA0012dat;
        ...
        SVertical = 3.0;          %Superficie del estabilizador
        c_ev = 1.337;             %cuerda
        theta_ev = -5*pi/180;    %ángulo de calado
