function F = systemPalaOmega(x,MHAdim,theta0,theta1c,theta1s,mu_xA,mu_yA,mu_zA,mu_WxA,mu_WyA,mu_WzA,omxA,omyA,omzA,lambda_0)
...
[beta0_2,beta1c_2,beta1s_2] = batimiento_omega(theta0,theta1c,theta1s,mu_xA,mu_yA,mu_zA,mu_WxA,mu_WyA,mu_WzA,omxA,omyA,omzA,lambda_iP,MHAdim);

[CH_2inA,CY_2inA,CT_2inA] = fza_rotorOmega(MHAdim,theta0,theta1c,theta1s,beta0,beta1c,beta1s,lambda_iP,...
    mu_xA,mu_yA,mu_zA,omxA,omyA,omzA,mu_WxA,mu_WyA,mu_WzA);
