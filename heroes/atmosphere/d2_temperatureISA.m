function d2_temperature = d2_temperatureISA(atmosphereData,h)
%d2_temperatureISA computes the 2nd derivative of the air temperature 
%   respect to altitude as a function of altitude.
%
%   d2_temperature = d2_temperatureISA(atmosphereData,h) returns the 2nd
