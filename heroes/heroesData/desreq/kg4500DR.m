function desreq = kg4500DR
% kg4500DR is a design requirement corresponding to an 4500 kg
% helicopter. The most well-known helicopter with design requirements 
% similar to this is the EC155 B1.
%
% From wikipedia
% The Eurocopter EC155 is a long-range medium-lift passenger transport 
% helicopter developed by Eurocopter from its Dauphin family for civil 
% aviation use. It is a twin-engined aircraft and can carry up to 13 
% passengers along with 1 or 2 crew, depending on customer configuration. 
% The helicopter is marketed for passenger transport, offshore support, VIP 
% corporate transport and casualty transport duties.
%
% This DR comes from Maria Sanz (2014) mariass0@alumnos.upm.es
%
...
costFactors = struct( ...
     'compositeAdditionalPrice',1000, ...   % [$/kg]
            'compositeFraction',0.4, ...    % [-] fraction W_MTO
                   ...
                   'numEngines',1,...       % [1.0 for multi-engine aircraft|0.736 for sigle-engine aircraft]
                       'lgType',1,...   % [1.0 for retractable landing gear|0.884 for fixed landing gear]
...
desreq.estimations.Sbody=65;
desreq.estimations.Wempty=2500*9.81;