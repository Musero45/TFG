function desreq = kg9000DR
% kg9000DR is a design requirement corresponding to an 9000 kg
% helicopter. The most well-known helicopter with design requirements 
% similar to this is the Bell 525.
%
% From wikipedia
% The Bell 525 Relentless is a proposed American medium-lift helicopter, 
% currently under development by Bell Helicopter. The Bell 525 was 
% unveiled at the 2012 Heli Expo in Dallas, Texas on February 12, 2012. 
% Bell expects the 525 to take its first flight in late 2014, with 
% certification expected in 2015. For more information 
% http://bell525supermedium.net/
%
% This DR comes from Alvaro Moreno (2014) alvaro.msacristan@alumnos.upm.es
%
...
costFactors = struct( ...
     'compositeAdditionalPrice',1000, ...   % [$/kg]
            'compositeFraction',0.4, ...    % [-] fraction W_MTO
                   ...
                   'numEngines',1.0,...     % [1.0 for multi-engine aircraft|0.736 for sigle-engine aircraft]
                       'lgType',1.0,...     % [1.0 for retractable landing gear|0.884 for fixed landing gear]
...
energyEstimations =  struct( ...
            ...
            'K',5,...
            'cd0',0.01,...
            'kindOfFuselage','highDragFuselage',...
            'etaTra',0.07,...
            'etaTrp',0.12,...
            'eta_ra',0.06 ...
);
...
desreq.estimations.Sbody=73;
desreq.estimations.Wempty=5130*9.81;
