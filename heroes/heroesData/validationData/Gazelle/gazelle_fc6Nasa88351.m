function [FC,muWT,h,he,mu]=FlightCondition6(he)
% Flight condition #6 defined according to page 17 of [1]
%
%% References
...
h            = 308;
he.inertia.W = 1967*9.8 ;
mu  = 0.3783;
% CT0 = 0.0645.*he.mainRotor.solidityMR;
