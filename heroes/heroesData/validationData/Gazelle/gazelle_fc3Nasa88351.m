function [FC,muWT,h,he,mu]=FlightCondition3(he)
% Flight condition #3 defined according to page 17 of [1]
%
%% References
...
h            = 235;
he.inertia.W = 1951*9.8 ;
mu  = 0.338;
% CT0 = 0.125.*he.mainRotor.solidityMR;
