function [FC,muWT,h,he,mu]=FlightCondition7(he)
% Flight condition #7 defined according to page 17 of [1]
%
%% References
...
h            = 292;
he.inertia.W = 1961*9.8 ;
mu  = 0.3552;
% CT0 = 0.094.*he.mainRotor.solidityMR;
