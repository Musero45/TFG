function [FC,muWT,h,he,mu]=FlightCondition1(he)
% Flight condition #1 defined according to page 17 of [1]
%
%% References
...
h            = 317;
he.inertia.W = 1985*9.8 ;
mu  = 0.14;
% CT0 = 0.065.*he.mainRotor.solidityMR;
