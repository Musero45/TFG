function [optStatHe, Svt, cHTP] = optionData
%OPTIONDATA Selects the estimated main Aerodynamic elements
%   Here must be configurated the first aerodynamic configuration. In this
%   case is selected Bo105 data
